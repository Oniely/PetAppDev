     ...
     <SafeAreaView className='flex-1'>
       <ScrollView className='flex-1 bg-off-white px-4 pt-6'>
        <View className='flex-row items-center justify-between bg-main-orange px-5 py-3 rounded-2xl mb-6'>
          <View>
            <Text style={{ fontFamily: "Poppins_600SemiBold" }} className='text-xl text-white'>Lets Find Specialist</Text>
            <Text style={{ fontFamily: "Poppins_600SemiBold" }} className='text-xl text-white'>Doctor for Your Pet!</Text>
          </View>
          <View>
            <Image source={require("@/assets/images/dogo_care.jpg")} className='w-[95px] h-[95px] rounded-lg' />
          </View>
        </View>
        ...
        <View className='mt-6 mb-3'>
          <Text style={{ fontFamily: "Poppins_500Medium" }} className='text-base'>Service Provider</Text>
        </View>
